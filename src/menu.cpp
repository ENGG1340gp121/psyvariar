...
//	keypad(stdscr, TRUE);
    ...
    wmove(new_win,2,0);
    wprintw(new_win, "1. Introduction:\nWelcome to Psyvariar, a text-based game where you control a fighter plane and battle against waves of enemy planes.\nYour mission is to destroy enemy planes as more as possible.\n2. Controls:\nUse the arrow keys to move your plane up, down, left, and right.\nPress the spacebar to fire bullets at the enemy planes.\n3. Score:\nYou will get 10 scores for destroying every enemy plane.\n4. Health:\nYou will have 10 health points (HP) at the beginning.\nYour HP will decrease by 1 for receiving every hit by the bullets fired by enemy planes.\nYour HP will become 0 as soon as your aircraft crashes into enemy planes or obstacles\n5. Game Over:\nThe game will end as soon as the HP of your aircraft becomes 0.\nYour final score will be displayed, and you will have the option to play again.\n\nThat's it! We hope this helps you get started on your Plane War game. Good luck!");
